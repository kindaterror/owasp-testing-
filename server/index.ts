...
// Serve static files (kept after APIs are mounted below via serveStatic)
...
(async () => {
  try {
    ...
    // Prove that routes were mounted in this running process
    console.log("Routes mounted: expecting POST /api/auth/login to be live");
    ...
    if (process.env.NODE_ENV !== "production") {
      ...
      serveStatic(app); // static and SPA fallback after API routes [correct order]
    }
